...
export default function Home() {
  ...
  return (
    <main>
      ...
      {/* SECCIÓN MONART X MARISE */}
      <section className={styles.monartSection}>
        <div className={styles.monartHeader}>
          <Image
        ...
        <div className={styles.monartContent}>
          <div className={styles.monartText}>
            <p>
              Pasteles espectaculares + caketoppers personalizados = magia en la mesa. 
              Trabajamos juntas para darle ese toque especial a cada creación. 
              Aquí te mostramos algunos de nuestros mejores trabajos. ✨
            </p>
          </div>
          <div className={styles.monartImage}>
            <Image
              src="/images/monart_x_marise_foto.png"
              alt="MonArt x Marise - Foto de colaboración"
              width={300}
              height={300}
              style={{
                height: 'auto',
        ...
        <div className={styles.monartCTA}>
          <Link href="/mon-art-x-marise" className={styles.monartButton}>
            Ver galería →
          </Link>
        </div>
      </section>
